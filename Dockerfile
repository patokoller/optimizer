...
CMD ["sh", "-c", "alembic stamp 001_initial_schema 2>/dev/null || true && alembic upgrade head && uvicorn app.main:app --host 0.0.0.0 --port ${PORT:-8000} --workers 2 --log-level info"]
